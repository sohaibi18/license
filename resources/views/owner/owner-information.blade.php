<x-layouts.app>
    <div class="container-xxl flex-grow-1 container-p-y">
        <form method="POST" action="/product/verified" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <ul class="list-unstyled mb-4" style="font-size: 16px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text"
                                                           class="form-control border border-primary font-weight-bold"
                                                           value="{{ optional(optional($license->business->product_applications)
                                                                ->first())->license_category->License_Category_Name }}"
                                                           readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text"
                                                           class="form-control border border-primary font-weight-bold"
                                                           value="{{ optional($license->payments)->Paid_Amount }}"
                                                           readonly>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text"
                                                           class="form-control border border-primary font-weight-bold"
                                                           value="{{ optional($license->payments)->Challan_No }}"
                                                           readonly>
                                                </div>
                                            </div>
                                            <br>
                                        ...
                                        <ul class="list-unstyled mb-4" style="font-size: 16px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text"
                                                           class="form-control border border-primary font-weight-bold"
                                                           value="{{  optional($license->payments)->Verify_By }}"
                                                           readonly>
                                                </div>
                                            </div>
                                            <br>
